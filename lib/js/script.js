...
$(function(){
    ...
    socket.on('connect', function() {
        ...
        socket.emit('auth', authRequest, function(err, authResponse) {
            ...
            chatMonitor.innerHTML += "<span class=\"chatMessage\"><span style=\"color: #F1C40F;font-weight:bold;\">Warning:</span> Never give your access_token to anyone or run unknown scripts. This may compromise your wallet security.<br></span>";
...
function addNewChatMessage(data){
    ...
    if(message.split(" ")[0] == "!tip" && message.split(" ").length == 3){
        if(message.split(" ")[2] == parseInt(message.split(" ")[2])){
