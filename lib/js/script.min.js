...
}),$("#logoutButton").click(function(){"undefined"!=typeof $.session.get("session_access_token")&&$.session.remove("session_access_token"),window.location.href="/"});}),$("#logoutButton").click(function(){"undefined"!=typeof $.session.get("session_access_token")&&$.session.remove("session_access_token"),window.location.href="/"});